...
@app_calendar.route('/login/', methods=["GET", "POST"])
def crud_login():
...
@app_calendar.route('/authorize/', methods=["GET", "POST"])
def crud_authorize():
...
@app_calendar.route('/logout/', methods=["GET", "POST"])
def crud_logout():
    logout_user()
...
@app_calendar.route('/search/term/', methods=["POST"])
def search_term():
